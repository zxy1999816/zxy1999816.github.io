<template>
  <div>
      <p style="font-size:24px;text-align:center;border-bottom:1px solid #ccc;line-height:.8rem"><a href="#/" style="color:green;position:absolute;left:10px;"><</a>女频</p>
...
export default {
  ...
  created(){
    this.book_id = this.$route.params.cid;
        ...
        this.$http.get('http://read.xiaoshuo1-sm.com/novel/i.php?do=is_caterank&p=1&page=1&words=&shuqi_h5=&onlyCpBooks=1&tag=%E7%8E%8B%E5%A6%83&sort=monthHot&_=1582376577433', {
            params: {
               do: "is_caterank",
                p: 1,
                page: 1,
